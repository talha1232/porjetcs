...
def start(): #mian starting fucntion 
    #ask use for input input
    choice=input("""do you want to add type "add" or remove email from subscription list type "remove" or  to send out Email type  "Email out" :""").lower() 
    if choice == "email out":
        emailbot()
